...
import { AuthRoute, UserRoute, StockRoute, NewsRoute, WatchlistRoute } from '../routes';
...
class App {
  ...
  constructor(
    env: EnvVariables = new EnvVariables(),
    routes: Route[] = [new UserRoute(), new AuthRoute(), new StockRoute(), new NewsRoute(), new WatchlistRoute()]
  ) {
    this.app = express();
    this.port = env.port;
