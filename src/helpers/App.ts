...
import { AuthRoute, UserRoute, StockRoute } from '../routes';
...
class App {
  ...
  constructor(env: EnvVariables = new EnvVariables(), routes: Route[] = [new UserRoute(), new AuthRoute(), new StockRoute()]) {
    this.app = express();
    this.port = env.port;
