...
import { AuthRoute, UserRoute, StockRoute, NewsRoute } from '../routes';
...
class App {
  ...
  constructor(env: EnvVariables = new EnvVariables(), routes: Route[] = [new UserRoute(), new AuthRoute(), new StockRoute(), new NewsRoute()]) {
    this.app = express();
    this.port = env.port;
