      ...
      {tickerPrice.prices[0].changePercent > 0 ? (
        <div className='list-inline'>
          ...
          <div className='d-inline ticker-price-percent ticker-badge-green font-green-dark'>
            <FontAwesomeIcon className='ticker-icon' icon={faCaretSquareUp} /> {tickerPrice.prices[0].changePercent}%
          </div>

          <div className='list-inline-item ticker-price-change font-green-dark'>+{tickerPrice.prices[0].priceChange} Today</div>
        </div>
      ) : (
        <div className='list-inline'>
          <div className='list-inline-item ticker-price'>{tickerPrice.prices[0].price}</div>
          <div className='d-inline ticker-price-percent ticker-badge-red font-red-dark'>
            <FontAwesomeIcon className='ticker-icon' icon={faCaretSquareDown} /> {tickerPrice.prices[0].changePercent}%
          </div>

          <div className='list-inline-item ticker-price-change font-red-dark'>{tickerPrice.prices[0].priceChange} Today</div>
        </div>
      )}
    </div>
  );
