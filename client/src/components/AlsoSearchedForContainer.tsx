...
const AlsoSearchedForContainer: React.FC = ({}) => {
        ...
        <Container className='position-relative'>
          ...
          <Container className='mt-3 discover-container' ref={discContainerRef}>
            {tickerPrices?.map((ticker: TickerPrice) => (
              <AlsoSearchedFor tickerPrice={ticker} key={ticker.symbol} />
            ))}
          </Container>
        </Container>
      ) : (
...
export default AlsoSearchedForContainer;
